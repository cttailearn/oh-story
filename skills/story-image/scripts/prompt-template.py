...
STYLE_TAGS = {
    ...
    # 默认画风档（未指定 style 或非平台档时兜底；真实系真人风格，权威定义见 visual-styles.md「默认画风（兜底档）」）
    "general":  ("photorealistic realistic style, professional portrait photography, natural skin texture with fine detail, realistic facial features, detailed hair strands, soft cinematic studio lighting, natural color grading, true-to-life skin tones, clean composition", "sharp focus, shallow depth of field, elegant neutral background, avoid plastic CG look, avoid anime or illustration style"),
